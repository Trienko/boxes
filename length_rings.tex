...
%https://math.stackexchange.com/questions/1226287/left-and-right-multiplication-for-cayley-graphs
...
\end{theorem}
\begin{proof}
%NB TAKEN VERBATIM from https://kconrad.math.uconn.edu/blurbs/grouptheory/genset.pdf SO NEEDS TO BE REWORDED
...
\begin{proof}
%copied verbatim from http://www.math.wm.edu/~vinroot/415conj.pdf
...
\end{lemma}
\begin{proof}
% proof taken verbatim from https://kconrad.math.uconn.edu/blurbs/grouptheory/Ansimple.pdf
